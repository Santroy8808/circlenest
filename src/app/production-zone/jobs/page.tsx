    ...
    <AppShell>
      <section className="card space-y-4 p-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Free and Contributor members can browse jobs. Only Biz members can post jobs.</p>
        </div>
        <div className="grid gap-3 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-400">
              {canCreate ? "Biz members can post jobs." : "Only Biz members can post jobs."}
            </p>
