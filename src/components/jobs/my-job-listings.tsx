...
import type { JobListingCardView } from "@/modules/jobs/types";

export function MyJobListings({
  listings,
  viewerCanCreate
}: {
  listings: JobListingCardView[];
      ...
      <section className="surface rounded-md p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-semibold">My Job Listings</h1>
            <p className="mt-3 max-w-2xl leading-7 text-[var(--muted)]">
              Review the jobs you created. Choose Edit to update a listing.
            </p>
          </div>
