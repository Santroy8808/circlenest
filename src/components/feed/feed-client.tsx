      ...
      <div className="feed-communicate-wrap">
        ...
        {composerOpen ? (
          <form className="feed-composer surface rounded-md" onSubmit={submitPost}>
            ...
            <button className="btn-primary mt-2 justify-self-end" disabled={isPending || (!body.trim() && !postImage)} type="submit">
              ...
              <div className="feed-comment-preview">
                ...
                {replyTarget ? (
                  <form className="feed-comment-composer is-quick-reply" onSubmit={(event) => submitComment(post.id, event, replyTarget.parentCommentId)}>
                    ...
                    <button className="btn-secondary justify-self-start" disabled={isPending || (!commentBodies[activeCommentKey]?.trim() && !commentImage)} type="submit">
                      Reply
                    </button>
                  </form>
                ) : null}
